...
export default class ShopNow extends Component {
  render() {
    return (
      <div className="d-none d-md-flex flex-row align-items-center mx-auto p-5 rounded-border bg-gray bg-shop">
        <div className="mx-auto my-5">
          <span className="text-center">
            <p className="font-w-800 my-3">Introducing</p>
            <h2 className="font-w-800 my-3 font-size-50pt">Airbnb gift <br /> cards</h2>
